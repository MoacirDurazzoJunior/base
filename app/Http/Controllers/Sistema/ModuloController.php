...
use App\Services\Sistema\ModuloService;
use App\Validators\Sistema\ModuloValidator;
...
class ModuloController extends BaseController
{
    ...
    {
        $this->validator = new ModuloValidator();
     ...
     */
    public function index(Request $request, $view = 'pages.sistema.modulos.index')
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function create($view = 'pages.sistema.modulos.create')
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(Request $request, $route = 'sistema.modulos.index')
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function show($id, $view = 'pages.sistema.modulos.show')
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit($id, $view = 'pages.sistema.modulos.edit')
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, $id, $route = 'sistema.modulos.index')
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy($id, $route = 'sistema.modulos.index')
    {
